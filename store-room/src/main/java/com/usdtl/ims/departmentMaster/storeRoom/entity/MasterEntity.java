package com.usdtl.ims.departmentMaster.storeRoom.entity;

import com.fasterxml.jackson.annotation.JsonIgnore;
import com.usdtl.ims.common.exceptions.constants.Category;
import com.usdtl.ims.departmentMaster.storeRoom.StoreRoomEntity;
import lombok.*;
...
public class MasterEntity {
    ...
    @JsonIgnore
    private List<StoreRoomEntity> storeRoomMasterItem;
}
