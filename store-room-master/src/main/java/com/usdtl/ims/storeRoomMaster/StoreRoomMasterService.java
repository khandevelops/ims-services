    ...
    public Page<StoreRoomMasterTransformedResponse> getStoreRoomMasterItemsByPage(Integer page) {
        ...
        storeRoomMasterItems.forEach(storeRoomMasterItem -> {
            StoreRoomMasterTransformedResponse storeRoomMasterResponse = StoreRoomMasterTransformedResponse.builder()
                    ...
                    .min_quantity(storeRoomMasterItem.getMinimum_quantity())
                    .max_quantity(storeRoomMasterItem.getMaximum_quantity())
                    .order_quantity(getOrderQuantity(storeRoomMasterItem.getMinimum_quantity(), storeRoomMasterItem.getMinimum_quantity(), storeRoomMasterItem.getQuantity()))
