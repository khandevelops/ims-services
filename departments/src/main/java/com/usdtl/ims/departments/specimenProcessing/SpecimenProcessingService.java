...
public class SpecimenProcessingService {
    ...
    public SpecimenProcessingEntity createItem(SpecimenProcessingEntity request) {
    ...
    public SpecimenProcessingEntity updateItem(Integer id, SpecimenProcessingEntity request) {
    ...
    public Page<SpecimenProcessingEntity> getItems(Integer page) {
        PageRequest pageRequest = PageRequest.of(page, 10);
        return repository.findAll(pageRequest);
    }

    public SpecimenProcessingEntity getItem(Integer id) throws NotFoundException {
