package com.usdtl.ims.departmentMaster.qualityMaster.qualityMaster;
...
public class QualityMasterService {
    private QualityMasterRepository repository;
    ...
    public QualityMasterEntity createItem(QualityMasterRequest request) {
        QualityMasterEntity newItem = QualityMasterEntity.builder()
    ...
    public Page<QualityMasterEntity> getExtractionsExperienceItemsByPage(Integer page) {
        PageRequest pageRequest = PageRequest.of(page, 10);
    ...
    public Page<DepartmentMasterResponse> getExperienceItemsByPage(Integer page) {
        ...
        List<QualityMasterEntity> extractionsItems = repository.findAll(pageRequest).getContent();
    ...
    public QualityMasterEntity getItemById(Integer id) throws NotFoundException {
        QualityMasterEntity item = repository.findById(id).orElseThrow(() ->  new NotFoundException("Item associated with id: " + id + " not found"));
        return item;
    }
