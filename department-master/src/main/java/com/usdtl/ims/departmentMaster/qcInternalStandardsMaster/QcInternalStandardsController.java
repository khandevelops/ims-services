...
public class QcInternalStandardsController {
    private QcInternalStandardsMasterService service;
    ...
    @GetMapping("list/raw")
    public Page<QcInternalStandardsMasterEntity> getExtractionsExperienceItemsByPage(@RequestParam Integer page) {
        return service.getExtractionsExperienceItemsByPage(page);
    }
    @GetMapping(path = "{id}")
    public  ResponseEntity<QcInternalStandardsMasterEntity> getItemById(@PathVariable(value = "id") Integer id) throws NotFoundException {
        return new ResponseEntity<>(service.getItemById(id), HttpStatus.OK);
    }

    @PostMapping
    public ResponseEntity<QcInternalStandardsMasterEntity> createItem(@RequestBody QcInternalStandardsMasterRequest request) {
