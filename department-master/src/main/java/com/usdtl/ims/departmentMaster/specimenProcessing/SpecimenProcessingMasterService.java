...
public class SpecimenProcessingMasterService {
    private SpecimenProcessingMasterRepository repository;
    ...
    public SpecimenProcessingMasterEntity createItem(SpecimenProcessingMasterRequest request) {
        SpecimenProcessingMasterEntity newItem = SpecimenProcessingMasterEntity.builder()
    ...
    public Page<SpecimenProcessingMasterEntity> getExtractionsExperienceItemsByPage(Integer page) {
        PageRequest pageRequest = PageRequest.of(page, 10);
    ...
    public Page<DepartmentMasterResponse> getExperienceItemsByPage(Integer page) {
        ...
        List<SpecimenProcessingMasterEntity> extractionsItems = repository.findAll(pageRequest).getContent();
    ...
    public SpecimenProcessingMasterEntity getItemById(Integer id) throws NotFoundException {
        SpecimenProcessingMasterEntity item = repository.findById(id).orElseThrow(() ->  new NotFoundException("Item associated with id: " + id + " not found"));
        return item;
    }
