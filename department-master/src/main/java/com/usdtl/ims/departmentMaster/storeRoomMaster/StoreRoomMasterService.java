...
public class StoreRoomMasterService {
    ...
    public StoreRoomMasterEntity createItem(StoreRoomMasterRequest request) {
        StoreRoomMasterEntity newItem = StoreRoomMasterEntity.builder()
    ...
    public Page<StoreRoomMasterEntity> getExtractionsExperienceItemsByPage(Integer page) {
        PageRequest pageRequest = PageRequest.of(page, 10);
    ...
    public Page<DepartmentMasterResponse> getExperienceItemsByPage(Integer page) {
        ...
        List<StoreRoomMasterEntity> extractionsItems = repository.findAll(pageRequest).getContent();
    ...
    public StoreRoomMasterEntity getItemById(Integer id) throws NotFoundException {
        StoreRoomMasterEntity item = repository.findById(id).orElseThrow(() ->  new NotFoundException("Item associated with id: " + id + " not found"));
        return item;
    }
