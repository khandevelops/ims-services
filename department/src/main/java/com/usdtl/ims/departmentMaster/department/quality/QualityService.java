...
public class QualityService {
    ...
    public List<QualityEntity> updateDepartmentItems(List<QualityEntity> requestItems) {
        List<QualityEntity> updateItems = new ArrayList<>();
        requestItems.forEach(departmentItem -> {
            QualityEntity item = repository.findById(departmentItem.getId()).orElseThrow(() -> new NotFoundException("Item associated with id: " + departmentItem.getId() + " not found"));
