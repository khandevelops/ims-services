...
public class ScreeningService {
    ...
    public List<ScreeningEntity> updateDepartmentItems(List<ScreeningEntity> requestItems) {
        List<ScreeningEntity> updateItems = new ArrayList<>();
        requestItems.forEach(departmentItem -> {
            ScreeningEntity item = repository.findById(departmentItem.getId()).orElseThrow(() -> new NotFoundException("Item associated with id: " + departmentItem.getId() + " not found"));
