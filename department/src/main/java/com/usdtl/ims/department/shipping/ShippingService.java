...
public class ShippingService {
    ...
    public List<ShippingEntity> updateDepartmentItems(List<ShippingEntity> requestItems) {
        List<ShippingEntity> updateItems = new ArrayList<>();
        requestItems.forEach(departmentItem -> {
            ShippingEntity item = repository.findById(departmentItem.getId()).orElseThrow(() -> new NotFoundException("Item associated with id: " + departmentItem.getId() + " not found"));
